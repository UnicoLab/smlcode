...
```
slmcode_0.20.0_darwin_arm64      slmcode_0.20.0_windows_amd64.exe
slmcode_0.20.0_darwin_amd64      slmcode_0.20.0_windows_arm64.exe
slmcode_0.20.0_linux_arm64       install.sh  install.ps1  install.cmd
slmcode_0.20.0_linux_amd64       SHA256SUMS
```
...
curl -fsSLO https://github.com/UnicoLab/smlcode/releases/download/v0.20.0/slmcode_0.20.0_darwin_arm64
shasum -a 256 -c SHA256SUMS --ignore-missing        # must say OK
chmod +x slmcode_0.20.0_darwin_arm64
./slmcode_0.20.0_darwin_arm64 version --json        # version 0.20.0, real commit, real built
```
